...
Server side routing is when you click a link and are directed to a webpage. Client side routing is used for getting and sending data with HTTP requests.
